...
public class DishServiceImpl extends ServiceImpl<DishMapper, Dish> implements DishService {
    ...
    public void deleteWithFlavor(List<Long> ids) {
        ...
        // 删除口味
        LambdaQueryWrapper<DishFlavor> queryWrapper_dishFlavor = new LambdaQueryWrapper<>();
        queryWrapper_dishFlavor.in(DishFlavor::getDishId,ids);
        dishFlavorService.remove(queryWrapper_dishFlavor);
    }
